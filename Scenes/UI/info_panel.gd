...
func update_items() -> void:
    ...
    for prop in filter_props_truthy:
        entities_by_truthy[prop] = EntityManager.find_all_entities_with_truthy_property(prop, true, [], true)
    var entities_by_falsey: = {}
    for prop in filter_props_falsey:
        entities_by_falsey[prop] = EntityManager.find_all_entities_with_truthy_property(prop, true, [], false)
