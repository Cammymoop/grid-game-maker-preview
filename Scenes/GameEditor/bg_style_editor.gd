...
func load_bg_style(manual_fetched: bool = false) -> void:
    ...
    var raw_line_scroll_angle: float = bg_style.get("lines_scroll_angle", 0.4)
    var conv_line_scroll_angle: = _turn_to_deg(raw_line_scroll_angle)
    prints("raw line scroll angle: ", raw_line_scroll_angle, "converted to deg: ", conv_line_scroll_angle)
    ln_scroll_angle_input.set_value(conv_line_scroll_angle)
