...
func resolve_conditional_old(conditional_name, conditional_data, owning_entity, target_entity, tile_position, arguments):
	...
	if result and "actions" in conditional_data:
		for a in conditional_data['actions']:
			if do_action_old(a, owning_entity, target_entity, tile_position, arguments):
				quit = true
...
func do_action_old(action_data, owning_entity, target_entity, tile_position, arguments):
