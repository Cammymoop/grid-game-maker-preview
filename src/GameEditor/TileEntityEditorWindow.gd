...
func _ready():
    ...
    terrain_sprite_modifier_edit.multi_line_text_changed.connect(on_terrain_sprite_modifier_text_changed)
    terrain_sprite_modifier_edit.multi_line_text_submitted.connect(on_terrain_sprite_modifier_text_submitted)
...
func _update_terrain_sprite_modifier_ui() -> void:
    var terrain_spr_mod_switch: CheckButton = find_child("TestTerrainSprMod")
...
func _on_ControllerOptionsShow_pressed():
    ...
    if "controller_options" in the_definition:
        ...
        current_option_values.merge(EntityManager.get_controller_default_options(controller_instance), false)
    else:
        current_option_values = EntityManager.get_controller_default_options(controller_instance)
